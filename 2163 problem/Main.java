 ...
 * 적당한 위치에서 초콜릿을 쪼갠다. 초콜릿을 쪼갤 때에는 금이 가 있는 위치에서만 쪼갤 수 있다. 이와 같이 초콜릿을 쪼개면 초콜릿은 두 개의 조각으로 나눠지게 된다. 이제 다시 이 중에서 초콜릿 조각을 하나 들고,
 * 쪼개는 과정을 반복하면 된다.
...
public class Main {
	...
	public static void main(String[] args) throws Exception{
		...
		int num=sc.nextInt();
		int num2=sc.nextInt();
		int answer=((num>=num2?num:num2)-1)+(num>=num2?num:num2)*((num>=num2?num2:num)-1);
